...
template<> struct HashKey<2> {
  ...
  static constexpr int       num1DBits = 52;
#else
  ...
  static constexpr int       num1DBits = 31;
#endif
  static constexpr int       bits1D()    { return num1DBits; }
  // When multiplying two coordinates together
  static constexpr int       wideWidth = num1DBits*2;
  using Wide = ac_int<wideWidth, true>;
  // When multiplying a Wide and a coordinate int
  static constexpr int       bigWidth = num1DBits*3;
...
template<> struct HashKey<3> {
  ...
  static constexpr int       numBits = 128;
  static constexpr int       num1DBits = 42;
